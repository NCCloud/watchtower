...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *StatusUpdateFilter) DeepCopyInto(out *StatusUpdateFilter) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new StatusUpdateFilter.
func (in *StatusUpdateFilter) DeepCopy() *StatusUpdateFilter {
	if in == nil {
		return nil
	}
	out := new(StatusUpdateFilter)
	in.DeepCopyInto(out)
	return out
}
